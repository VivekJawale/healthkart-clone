...
const PrePostFilterComp = () => {

    const categories= [{value:"Pre Workout", name:"Pre Workout"}, {value:"Creatine", name:"Creatine"},
    {value:"ripped", name:"BCAAs"}, {value:"carb", name:"Carb Blends"},
    {value:"formula", name: "Eloctrolytes"}, {value:"muscles", name:"EAA"},
    {value:"nitraflex", name:"Nitric Oxide"}, {value:"Citrulline", name:"Citrulline Malate"},
    ];
...
export default PrePostFilterComp
