...
import WorkEssComp from './WorkEssComp';
import WorkEssFilterComp from './WorkEssFilterComp';
      ...
      <Box>
        <Box w={["90%", "90%", "80%"]} m="auto">
          <Box display="flex" gap="5px" alignItems="center">
            ...
            <Icon color="#2eb8b8" as={ChevronRightIcon} />
            <Link href="/products/workoutessential" fontSize="14px">Workout Essentials</Link>
          </Box>
        </Box>
...
export default WorkoutEssential
