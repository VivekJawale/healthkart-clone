...
const WorkEssFilterComp = () => {

    const categories= [{value:"fat", name:"Fat Burners"},{value:"car", name:"L Carnitine"},
    {value:"vit", name:"Multivitamins"},
    {value:"super", name:"Super Gainer"}, {value:"weight", name:"Weight Gainer"},
    {value:"mass", name:"Mass Gainer"}, {value:"tech", name: "Muscle Tech"}
    ];
...
export default WorkEssFilterComp
